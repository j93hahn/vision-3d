...
def mine_vs_open3d_pc(view=1):
    ...
    if view == 1:
        ...
        raise Exception("Invalid view specified")
...
def vis_camera_trajectory():
    ...
    cam = draw_camera(K, main_E, img_w, img_h)
    renderer.add(cam)
    ...
    traj_Es = generate_spiral_camera_trajectory(mesh, num_rounds=1)
    for E in traj_Es:
